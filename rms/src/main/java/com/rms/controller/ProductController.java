...
public class ProductController {
	...
	public ResponseEntity<HttpResponse> getAllProduct() {
		try {
			return new ResponseEntity<>(
					new HttpResponse(HttpStatus.OK.value(), DATA_SUCCESS, productService.getAllProduct()),
					HttpStatus.OK);
	...
	public ResponseEntity<HttpResponse> getProductById(@PathVariable Long id) {
		try {
			return new ResponseEntity<>(
					new HttpResponse(HttpStatus.OK.value(), DATA_SUCCESS, productService.getProductById(id)),
					HttpStatus.OK);
		} catch (BusinessLogicException e) {
			return new ResponseEntity<>(new HttpResponse(HttpStatus.BAD_REQUEST.value(), e.getMessage()),
					HttpStatus.BAD_REQUEST);
	...
	public ResponseEntity<HttpResponse> addProduct(@Valid @RequestBody ProductDto productDto) {
		try {
			return new ResponseEntity<>(new HttpResponse(HttpStatus.OK.value(), productService.addProduct(productDto)),
					HttpStatus.OK);
		} catch (BusinessLogicException e) {
			return new ResponseEntity<>(new HttpResponse(HttpStatus.BAD_REQUEST.value(), e.getMessage()),
					HttpStatus.BAD_REQUEST);
	...
	public ResponseEntity<HttpResponse> updateProduct(@PathVariable("id") Long id,
			@Valid @RequestBody ProductDto productDto) {
		try {
			return new ResponseEntity<>(
					new HttpResponse(HttpStatus.OK.value(), productService.updateProduct(id, productDto)),
					HttpStatus.OK);
		} catch (BusinessLogicException e) {
			return new ResponseEntity<>(new HttpResponse(HttpStatus.BAD_REQUEST.value(), e.getMessage()),
					HttpStatus.BAD_REQUEST);
	...
	public ResponseEntity<HttpResponse> deleteProduct(@PathVariable("id") Long id) {
		try {
			return new ResponseEntity<>(new HttpResponse(HttpStatus.OK.value(), productService.deleteProduct(id)),
					HttpStatus.OK);
		} catch (BusinessLogicException e) {
			return new ResponseEntity<>(new HttpResponse(HttpStatus.BAD_REQUEST.value(), e.getMessage()),
					HttpStatus.BAD_REQUEST);
